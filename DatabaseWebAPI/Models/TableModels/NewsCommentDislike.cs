 ...
 * File Name:     NewsCommentDislike.cs
 * File Function: NewsCommentDislike 模型类
...
[Table("NEWS_COMMENT_DISLIKE")]
[SwaggerSchema(Description = "新闻评论点踩表")]
[PrimaryKey(nameof(CommentId), nameof(UserId))]
public sealed class NewsCommentDislike
{
    // 属性定义
    [Column("COMMENT_ID")]
